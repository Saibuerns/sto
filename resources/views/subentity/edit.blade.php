...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Actualizar Sub Entidad</h3>
        </div>
        <form action="{!! route('subentity.update', ['idSubEntity' => $subEntity->id]) !!}" method="post" role="form">
            {!! csrf_field() !!}
            {!! method_field('PUT') !!}
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="idEntity" name="idEntity"
                                   value="{!! $subEntity->entity->id !!}" readonly>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="entityName" name="entityName"
                                   value="{!! $subEntity->entity->name !!}" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
