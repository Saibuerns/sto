    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                @include('entity.subentity.prefix.show', ['subEntity' => $subEntity])
                @else
                <div class="alert alert-info">                    
                    <p class="text-center">Aun no hay prefijos cargados!</p>
                </div> 
                @endif
                <div class="form-group pull-right">
                    <button class="btn btn-success" onclick="window.location = '{!!route('entity.subentity.prefix.create', ['idEntity' => $idEntity,'idSubEntity' => $subEntity->id])!!}'">Nuevo Prefijo</button>
                </div>
                <div class="form-group">
                    <button class="btn btn-success" onclick="window.location = '{!!route('entity.subentity.box.create', ['idEntity' => $idEntity,'idSubEntity' => $subEntity->id])!!}'">Nuevo Box</button>
                </div>
